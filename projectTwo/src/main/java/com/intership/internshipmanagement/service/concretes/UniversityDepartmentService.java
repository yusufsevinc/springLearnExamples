...
public class UniversityDepartmentService  {
    ...
    public UniversityDepartmentDto addDto(UniversityDepartmentDto universityDepartmentDto) {
    ...
    public UniversityDepartment add(UniversityDepartment universityDepartment) {
        try {
            return this.universityDepartmentRepository.save(universityDepartment);
        }catch (Exception e){
            throw new InternalServerError(Message.errorUniversityDepartmentAdding);
        }
